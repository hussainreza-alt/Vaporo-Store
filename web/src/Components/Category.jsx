...
export function Category(){
    ...
    return(
        <>
        <div id="products" className="grid gap-0 mt-10 justify-center p-5 w-screen h-auto align-top">
            <div className="grid justify-center w-full self-start" >
                ...
                <div className=" grid w-full font-int0er mb-2 justify-self-center justify-center text-center">
                    ...
                    <i className="text-gray-300 font-extralight mt-4 text-base sm:text-lg md:text-xl">Find exactly what you're looking for. <br /> Premium quality across every category</i>
                </div>
            </div>
            <br /><br />

            {/* laptop interface */}
            <div className=" hidden md:grid md:grid-cols-2 lg:max-h-fit lg:grid-cols-4">

                {/* first card */}
                <div className=" relative group w-[95%] h-fit lg:mt-0 overflow-hidden rounded-xl shadow-sm shadow-green-600 border border-gray-600">
                    <div>
                        {/* bg */}
                        <div className=" bg-custom1 absolute inset-0 bg-cover bg-center h-1/2 align-middle justify-self-center transition-transform duration-700 ease-in-out group-hover:scale-105">
                            <img loading="lazy" src="/vap1.png" className=" w-full opacity-75" alt="" />
                        </div>
                        ...
                        <div className=" relative z-10 w-full grid items-end align-bottom justify-start bg-linear-to-b from-transparent via-85% to-black text-white p-4">
                            ...
                            <div className=" mt-30 justify-self-center h-fit grid self-end">
                                <div className=" w-fit h-fit">
                                    <h3 className=" text-xl md:text-2xl font-medium">DISPOSABLES</h3>
                                ...
                                <div className=" mt-2 flex align-bottom pt-4 text-green-600 font-semibold text-2xl">
                                    <p>Explore</p>
                ...
                <div className=" relative group w-[95%] h-fit lg:mt-0 overflow-hidden rounded-xl shadow-sm shadow-green-600 border border-gray-600">
                    <div>
                        {/* bg */}
                        <div className=" bg-custom1 absolute inset-0 bg-cover bg-center h-1/2 align-middle justify-self-center transition-transform duration-700 ease-in-out group-hover:scale-105">
                            <img loading="lazy" src="/vap3.png" className=" w-full opacity-75" alt="" />
                        </div>
                        ...
                        <div className=" relative z-10 w-full grid items-end align-bottom justify-start bg-linear-to-b from-transparent via-85% to-black text-white p-4">
                            ...
                            <div className=" mt-30 justify-self-center grid self-end">
                                <div className=" w-fit h-fit">
                ...
                {/* third card */}
                <div className=" relative group md:mt-4 h-fit lg:mt-0 w-[95%] overflow-hidden rounded-xl shadow-sm shadow-green-600 border border-gray-600">
                    <div>
                        {/* bg */}
                        <div className=" bg-custom1 absolute inset-0 bg-cover bg-center h-1/2 align-middle justify-self-center transition-transform duration-700 ease-in-out scale-105 group-hover:scale-110">
                            <img loading="lazy" src="/vap4.png" className=" w-full opacity-75" alt="" />
                        </div>
                        ...
                        <div className=" relative z-10 w-full grid items-end align-bottom justify-start bg-linear-to-b from-transparent via-85% to-black text-white p-4">
                            ...
                            <div className=" mt-30 justify-self-center grid self-end">
                                <div className=" w-fit h-fit">
                                    ...
                                    <div className=" h-1 w-10 bg-linear-to-r from-green-600 to-transparent mt-2 mb-2"></div>
                                    <p className=" text-base w-fit font-normal md:text-xl h-fit wrap-break-word text-gray-300">Advanced pods for smooth performance</p>
                                </div>
                                <div className=" mt-1 flex align-bottom pt-4 text-green-600 font-semibold text-2xl">
                                    <p>Explore</p>
                                    <img src="/arr1.png" className="h-10 group-hover:scale-110 transition-transform duration-100 ease-in justify-self-end ml-auto brightness-115" alt="" />
                                </div>
                            </div>
                ...
                {/* fourth card */}
                <div className=" relative group md:mt-4 lg:mt-0 w-[95%] h-fit overflow-hidden rounded-xl shadow-sm shadow-green-600 border border-gray-600">
                    <div>
                        {/* bg */}
                        <div className=" bg-custom1 absolute inset-0 bg-cover bg-center h-full align-middle justify-self-center transition-transform duration-700 ease-in-out group-hover:scale-105">
                            <img loading="lazy" src="/va.png" className=" w-full opacity-75" alt="" />
                        </div>
            ...
            <div className="grid md:hidden">
                ...
                {/* first card */}
                    <div className="relative group mb-4 overflow-hidden rounded-xl shadow-sm shadow-green-700 border border-gray-600">
                        {/* bg */}
                        <div className="bg-custom1 absolute inset-0 bg-cover bg-center h-[200%] align-middle justify-self-end transition-transform duration-700 ease-in-out group-hover:scale-110"> 
                            <img loading="lazy" src="/vap1.png" className=" h-full opacity-75" alt="" />
                        </div>
                        {/* Foreground content */}
                        <div className="relative z-10 w-full md:w-[95%] flex gap-6 items-center justify-start bg-linear-to-l from-transparent via-black to-black text-white p-4">
                ...
                {/* second card */}
                    <div className="relative group mb-4 overflow-hidden rounded-xl shadow-sm shadow-green-700 border border-gray-600">
                        {/* bg */}
                        <div className="bg-custom1 absolute inset-0 bg-cover bg-center h-[200%] align-middle justify-self-end transition-transform duration-700 ease-in-out group-hover:scale-110"> 
                            <img loading="lazy" src="/vap3.png" className=" h-full opacity-75" alt="" />
                        </div>
                        {/* Foreground content */}
                        <div className="relative z-10 w-full md:w-[95%] flex gap-6 items-center justify-start bg-linear-to-l from-transparent via-black to-black text-white p-4">
                ...
                {/* third card */}
                    <div className="relative group overflow-hidden mb-4 rounded-xl shadow-sm shadow-green-700 border border-gray-600">
                        {/* bg */}
                        <div className="bg-custom1 absolute inset-0 bg-cover bg-center h-[200%] align-middle justify-self-end transition-transform duration-700 ease-in-out group-hover:scale-110"> 
                            <img loading="lazy" src="/vap4.png" className=" h-full opacity-75" alt="" />
                        </div>
                        {/* Foreground content */}
                        <div className="relative z-10 w-full md:w-[95%] flex gap-6 items-center justify-start bg-linear-to-l from-transparent via-black to-black text-white p-4">
                ...
                {/* fourth card */}
                    <div className="relative group overflow-hidden mb-4 rounded-xl shadow-sm shadow-green-700 border border-gray-600">
                        {/* bg */}
                        <div className="bg-custom1 absolute inset-0 bg-cover bg-center h-[200%] align-middle justify-self-end transition-transform duration-700 ease-in-out group-hover:scale-110"> 
                            <img loading="lazy" src="/va.png" className=" h-full opacity-75" alt="" />
                        </div>
                        {/* Foreground content */}
                        <div className="relative z-10 w-full md:w-[95%] flex gap-6 items-center justify-start bg-linear-to-l from-transparent via-black to-black text-white p-4">
                            <div className=" h-fit py-3 px-2 self-center justify-self-start rounded-full border border-green-600">
                                <img src="/vaa.png" alt="" className="h-10 brightness-75" />
                            </div>
                            <div className=" h-fit w-[50%] grid text-white font-inter">
                                <h3 className=" text-xl md:text-2xl font-medium">ACCESSORIES</h3>
